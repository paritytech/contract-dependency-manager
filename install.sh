...
# 5) Install cargo-pvm-contract from the main branch
...
if git clone -b main https://github.com/paritytech/cargo-pvm-contract.git /tmp/cargo-pvm-contract 2>&1; then
