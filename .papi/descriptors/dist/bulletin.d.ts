...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Ic1qn45u9b9hhu>, false, never>;
        /**
...
type IEvent = {
    ...
    SkipFeelessPayment: {
         ...
         */
        FeeSkipped: PlainDescriptor<Anonymize<I351cnlhk17436>>;
    };
    TransactionStorage: {
        /**
...
type IRuntimeCalls = {
    ...
    DryRunApi: {
         ...
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I1abqdpbsc75ie>>;
    };
    /**
