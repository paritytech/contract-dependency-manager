...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<If9lvpkvrdd4de>, false, never>;
        /**
    ...
    Game: {
         ...
         */
        Game: StorageDescriptor<[], Anonymize<I5dmkj9ep3uuaq>, true, never>;
        /**
         ...
         */
        GameSchedules: StorageDescriptor<[], Anonymize<I1v8hffmq0a2s2>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I5it21o0jtd7tv>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Ic37c8sv0qg4b0>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I5it21o0jtd7tv>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I836pgbqesdd45>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I5it21o0jtd7tv>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<If7dovroafg6a4>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<Ie0iqbm32cg74j>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I836pgbqesdd45>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I58amnp0la3bfe>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I9flfuhgqnl1rq>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I268pu64p3f4k5>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<If7dovroafg6a4>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I7r69pp73si76m>>;
        /**
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I5cb4tjvobg0au>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I30ni5od7hlit3>>;
        /**
    ...
    People: {
         ...
         */
        under_alias: TxDescriptor<Anonymize<I268pu64p3f4k5>>;
        /**
    ...
    Game: {
         ...
         */
        schedule_games: TxDescriptor<Anonymize<Isicv7jbqf8q2>>;
        /**
    ...
    PeopleLite: {
         ...
         */
        dispatch_as_signer: TxDescriptor<Anonymize<I268pu64p3f4k5>>;
    };
    Resources: {
        /**
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<Icar3l2h2o2l32>, proxy_type: Anonymize<Ieuemnllefri8h>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Icar3l2h2o2l32>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Icar3l2h2o2l32>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
...
export type IndividualityDispatchError = Anonymize<I8sjiu98a296ci>;
type IAsset = PlainDescriptor<Anonymize<If9iqq7i64mur8>>;
export type IndividualityExtensions = {
...
export type Individuality = {
    ...
    asset: IAsset;
    extensions: IndividualityExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: Individuality;
export default _allDescriptors;
export type IndividualityApis = ApisFromDef<IRuntimeCalls>;
export type IndividualityQueries = QueryFromPalletsDef<PalletsTypedef>;
export type IndividualityCalls = TxFromPalletsDef<PalletsTypedef>;
export type IndividualityEvents = EventsFromPalletsDef<PalletsTypedef>;
export type IndividualityErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type IndividualityConstants = ConstFromPalletsDef<PalletsTypedef>;
export type IndividualityViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type IndividualityCallData = Anonymize<Icar3l2h2o2l32> & {
    value: {
        type: string;
    };
};
type AllInteractions = {
    storage: {
        ...
        Score: ['Participants', 'PersonhoodThreshold', 'CurrentRoundPoints', 'CurrentRoundIndex', 'RoundsPointsForParticipant', 'RoundPayouts', 'RoundPlanning', 'RoundSchedules'];
    ...
    events: {
        ...
        Score: ['Credit', 'PersonhoodRecognized'];
    ...
    constants: {
        ...
        Score: ['VoucherType', 'CurrencyLocationInfo', 'OffchainWorkInterval', 'score_pot_id', 'score_context', 'ubi_points'];
...
export type IndividualityWhitelistEntry = PalletKey | `query.${NestedKey<AllInteractions['storage']>}` | `tx.${NestedKey<AllInteractions['tx']>}` | `event.${NestedKey<AllInteractions['events']>}` | `error.${NestedKey<AllInteractions['errors']>}` | `const.${NestedKey<AllInteractions['constants']>}` | `view.${NestedKey<AllInteractions['viewFns']>}` | `api.${NestedKey<AllInteractions['apis']>}`;
type PalletKey = `*.${({
