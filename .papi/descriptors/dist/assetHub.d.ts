...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I4ipo28ei2sof>, false, never>;
        /**
    ...
    Revive: {
         ...
         */
        EthereumBlock: StorageDescriptor<[], Anonymize<Idq3n4esn5nvc5>, false, never>;
        /**
...
type IRuntimeCalls = {
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I3q64cqlu12ma0>, call: Anonymize<Iapigu5kpoksm7>, result_xcms_version: number], Anonymize<Ibgqd2qu1lqovk>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I2pitf1lnpdbg9>>;
    };
    /**
